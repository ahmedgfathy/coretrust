const services = [
  { 
    ...
    desc: 'Research, site evaluation, and development of distinctive properties. From residential towers to luxury villas and commercial complexes across Egypt.', 
  ...
  { 
    ...
    titleAr: 'المقاولات', 
    desc: 'Executing projects with quality materials and expert engineering. From residential buildings to government projects and infrastructure.', 
  ...
  { 
    ...
    desc: 'Creating functional, elegant, and personalized interior spaces with 3D design solutions for residential and commercial projects.', 
  ...
  { 
    ...
    titleAr: 'الصيانة', 
    desc: 'Comprehensive maintenance for residential compounds, elevators, electromechanical systems, and building facades.', 
  ...
  { 
    title: 'Castings & Hardware', 
    titleAr: 'المسبوكات والخردوات', 
    desc: 'Production of die cast castings, sand casting, aluminum profiles, and stamp manufacturing for industrial applications.', 
  ...
  { 
    ...
    desc: 'Production of aluminum profiles by hot extrusion method in various sizes, shapes and surface treatment for architectural and industrial uses.', 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-10 sm:mb-14 lg:mb-16">
          <div className="flex items-center justify-center space-x-3 sm:space-x-4 mb-4 sm:mb-6">
            ...
            <span className="text-[#d4a017] text-[10px] sm:text-sm uppercase tracking-[0.2em] sm:tracking-[0.3em] font-medium">Our Divisions</span>
            <div className="w-8 sm:w-12 h-px bg-[#d4a017]"></div>
          </div>
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-4 sm:mb-6" style={{ fontFamily: 'Playfair Display, serif' }}>Our Divisions</h2>
          <p className="text-gray-400 text-sm sm:text-base md:text-lg max-w-3xl mx-auto px-4">A multidisciplinary company with 6 specialized divisions serving Egypt and international markets since 2004.</p>
        </div>
        
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
          {services.map((s, i) => (
            <div key={i} className="group bg-[#121226]/50 border border-[#d4a017]/20 p-5 sm:p-6 lg:p-8 hover:border-[#d4a017]/50 transition-all duration-500 card-hover relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <p className="text-[#d4a017] text-xs sm:text-sm mb-2 sm:mb-3">{s.titleAr}</p>
