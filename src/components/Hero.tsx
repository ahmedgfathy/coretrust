  ...
  return (
    <section id="home" className="relative min-h-screen overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto lg:mx-0">
            ...
            <div className="grid grid-cols-2 sm:flex sm:items-center sm:space-x-8 lg:space-x-16 mt-10 sm:mt-16 gap-6 sm:gap-0">
              <div className="text-center sm:text-left">
                ...
                <p className="text-gray-400 text-[10px] sm:text-xs md:text-sm mt-1 sm:mt-2 uppercase tracking-wider">Projects Completed</p>
              </div>
              ...
              <div className="text-center sm:text-left">
                ...
                <p className="text-gray-400 text-[10px] sm:text-xs md:text-sm mt-1 sm:mt-2 uppercase tracking-wider">Years Experience</p>
              </div>
              <div className="hidden sm:block w-px h-10 lg:h-14 bg-[#d4a017]/30"></div>
              <div className="text-center sm:text-left">
      ...
      <div className="absolute bottom-4 sm:bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center">
        <span className="text-gray-400 text-[10px] sm:text-xs uppercase tracking-widest mb-1 sm:mb-2">Scroll</span>
