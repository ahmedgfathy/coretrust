      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <div className="flex items-center justify-center space-x-4 mb-6">
            ...
            <span className="text-[#d4a017] text-sm uppercase tracking-[0.3em] font-medium">Our Journey</span>
            <div className="w-12 h-px bg-[#d4a017]"></div>
          </div>
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6" style={{ fontFamily: 'Playfair Display, serif' }}>Our Rich Company History</h2>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">From 2004, we have completed 90+ projects across Egypt and beyond, delivering innovative solutions and sustainable designs.</p>
        </div>
