        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12">
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-3 sm:space-x-4 mt-4 sm:mt-6">
              ...
              <a href="https://www.instagram.com/mohamed_yehia_group/" target="_blank" rel="noopener noreferrer" className="w-9 sm:w-10 h-9 sm:h-10 border border-[#d4a017]/30 flex items-center justify-center text-[#d4a017] hover:bg-[#d4a017]/10 transition-colors duration-300">
              ...
              <a href="https://www.linkedin.com/in/mohamed-yehia-group-4046b0380/" target="_blank" rel="noopener noreferrer" className="w-9 sm:w-10 h-9 sm:h-10 border border-[#d4a017]/30 flex items-center justify-center text-[#d4a017] hover:bg-[#d4a017]/10 transition-colors duration-300">
          ...
          <div>
            ...
            <ul className="space-y-3 sm:space-y-4">
              <li className="flex items-start space-x-2 sm:space-x-3">
                ...
                <span className="text-gray-400 text-xs sm:text-sm leading-relaxed">Zaher Towers - Building 2 - Apt 316B<br/>Maamoun St. Nasr City - Cairo - Egypt</span>
              </li>
              <li className="flex items-start space-x-2 sm:space-x-3">
                ...
                <span className="text-gray-400 text-xs sm:text-sm">info@mygroup-eg.com</span>
              </li>
              <li className="flex items-start space-x-2 sm:space-x-3">
                <svg className="w-4 sm:w-5 h-4 sm:h-5 text-[#d4a017] mt-0.5 sm:mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                <span className="text-gray-400 text-xs sm:text-sm">02-20776044</span>
              </li>
            </ul>
          </div>
        </div>
